...
?>
<div id="content-container" class="admin_category_index_ops">
                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                ...
                                <?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/search_index.php", [
                                    ...
                                    'form_action' => UrlService::buildAdminUrl('/category/index')
                                ]); ?>

                                <div class="col-sm-4 table-toolbar-right">
                                    <a href="<?= UrlService::buildWwwUrl('category/set') ?>" class="btn btn-purple">
