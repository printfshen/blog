...
StaticService::includeAppJsStatic('plugins/nifty-v2.5/demo/plugins/morris-js/raphael-js/raphael.min.js', AdminAsset::className());
                ...
                <div id="demo-panel-network" class="panel">
                    <div class="panel-heading">
                        <div class="panel-control">
                            <button id="demo-panel-network-refresh" data-toggle="panel-overlay"
                                    data-target="#demo-panel-network" class="btn"><i
                                        class="demo-pli-repeat-2 icon-lg"></i></button>
                            <div class="btn-group">
                                <button class="dropdown-toggle btn" data-toggle="dropdown"
                                        aria-expanded="false"><i class="demo-pli-gear icon-lg"></i></button>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body pad-lft">
                                        <div class="pad-btm">
                                            ...
                                            <small>A wonderful serenity has taken possession of my entire soul,
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <div class="panel panel-info panel-colorful">
                            <div class="pad-all">
                                <p class="text-lg text-semibold"><i class="demo-pli-wallet-2 icon-fw"></i>
                                    Earning</p>
                                <p class="mar-no">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <div class="panel panel-purple panel-colorful">
                            <div class="pad-all">
                                <p class="text-lg text-semibold"><i class="demo-pli-bag-coins icon-fw"></i>
                                    Sales</p>
                                <p class="mar-no">
                                    <span class="pull-right text-bold">$764</span>
                                    Today
                    ...
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <div class="panel panel-warning panel-colorful">
                            <div class="pad-all">
                                <p class="text-lg text-semibold"><i class="demo-pli-check icon-fw"></i> Task
                                    Progress</p>
                                <p class="mar-no">
                        ...
                        <ul class="list-group bg-trans bord-no">
                            ...
                            <li class="list-group-item list-item-sm">
                                ...
                                <div class="media-body">
                                    ...
                                    <br>
                                    Design my themes with <a href="#" class="btn-link text-bold">#Bootstrap</a>
